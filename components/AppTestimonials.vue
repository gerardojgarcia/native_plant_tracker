      ...
      testimonials: [
        {
          ...
          alt: 'image of yessica christy'

        },

        {
          id: 2,
          img: '/img/david_blanco_screenshot.webp',
          name: "David Blanco",
          ...
          alt: 'image of David Blanco'

        },
        {
          id: 3,
          img: '/img/stephanie_headshot.webp',
...
<template>
  <section id="testimonials" class="text-center pb-32 p-4"  data-aos="fade-up" data-aos-duration="300ms">
    ...
    <h5 class="text-4xl text-green-800 pb-8"  data-aos="fade-up" data-aos-duration="300ms">Meet Our Happy Planters</h5>
    ...
    <div class="plant-testimonials w-full md:w-4/5 flex flex-col md:flex-row justify-center m-auto md:space-x-8"  data-aos="fade-up" data-aos-duration="300ms">
      ...
      <div class="plant-testimonial-card flex flex-col md:justify-start rounded-lg bg-gray-100 pt-4 pb-8 mb-6 shadow-lg hover:shadow-2xl  " v-for="testimonial in testimonials" :key="testimonial.id">
        ...
        <div class="card-header flex justify-between items-center px-4 md:px-8">
          ...
          <div class="card-reviewer text-left flex w-full mb-8 items-center">  
            <img :src="testimonial.img" :alt=" testimonial.alt" class="w-24 h-24 rounded-full object-cover object-center">
            <div class="px-4" >
