      ...
      <div class="px-2 md:px-8">
        <div class="py-6 flex flex-col md:flex-row hero w-full">
          <div class="hero-header self-center pr-16">
            <h1 class="text-6xl font-bold pb-6">A Garden Made for SoCal</h1>
            <strong class="text-2xl">Create a garden with a self sustaining ecosystem</strong>
          </div>

          <nuxt-img
            src="/img/native-garden.png"
        ...
        <div class="space-y-16 px-4 md:px-16 md:w-5/6 m-auto text-lg mt-24">
          <strong class="text-3xl">Designing a Garden with a Southern California Native Ecosystem in Mind: Tips for Sustainability and Beauty
            </strong
          >
          <article>
...
<p>
  ...
  In conclusion, designing a Southern California native ecosystem garden is an opportunity to create a beautiful and sustainable space that supports the local ecosystem. By choosing native plants, using mulch and drought-tolerant landscaping techniques, creating habitat and wildlife, and incorporating sustainability practices, you can create a garden that is both beautiful and environmentally friendly. With a little planning and effort, you can create a garden that will be a source of pride and joy for years to come.
</p>
